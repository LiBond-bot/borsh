  ...
  <div class="styleswitcher-inner content-scroll">
    ...
    <div class="theme-design row mb-0 theme-background-wrapper">
      <div class="col-md-12 theme-box theme-option mb-4" opt="backgroundColor">
        ...
        <ul val="backgroundColor" class="bg bg-color-switcher theme-panel-save">
          <li>
			<a class="bg bg-color-0" dir="color_0" href="javascript:void(0);"><img src="assets/vendor/switcher/demo.png" alt=""></a>
		</li>
		  <li>
            <a class="bg bg-color-1" dir="color_1" href="javascript:void(0);"></a>
          </li>
          <li>
            <a class="bg bg-color-2" dir="color_2" href="javascript:void(0);"></a>
          </li>
          <li>
            <a class="bg bg-color-3" dir="color_3" href="javascript:void(0);"></a>
          </li>
          <li>
            <a class="bg bg-color-4" dir="color_4" href="javascript:void(0);"></a>
          </li>
          <li>
            <a class="bg bg-color-5" dir="color_5" href="javascript:void(0);"></a>
          </li>
          <li>
            <a class="bg bg-color-6" dir="color_6" href="javascript:void(0);"></a>
          </li>
          <li>
            <a class="bg bg-color-7" dir="color_7" href="javascript:void(0);"></a>
          </li>
        </ul>
      </div>
...
var dzSwitcher = (function () {
  ...
  var handleThemeLayout = function () {
    if (
      getCookie("themeLayout_value").length == 0 ||
      getCookie("themeLayout_value") == 1
    ) {
    ...
    jQuery(".layout-view li a").on("click", function () {
      ...
      if (
        jQuery(this).attr("dir") == "wide-layout" ||
        jQuery(this).attr("dir") == "boxed"
      ) {
    ...
    if (themeOptionItemValue != "" && themeOptionItemValue != "1") {
      if (themeOptionItem == "themeFullColor") {
        ...
        if (themeOptionItemValue.indexOf("color_") > -1) {
          jQuery(
            '.color-skins [data-color-theme="' + themeOptionItemValue + '"]'
          )
            .parent()
            .addClass("active");
        }
        ...
        jQuery(".corner-view li").removeClass("active");
        jQuery('.corner-view [dir="' + themeOptionItemValue + '"]')
          .parent()
          .addClass("active");
      } else if (
        themeOptionItem == "backgroundColor" &&
        ...
        themeOptionItem == "backgroundImage" &&
        themeOptionItemValue != "" &&
        themeOptionItemValue != 1
      ) {
        jQuery("#bg").css({
        ...
        themeOptionItem == "backgroundPattern" &&
        themeOptionItemValue != "" &&
        themeOptionItemValue != 1
      ) {
        jQuery("#bg").css({
