...
<section class="menu content-inner-4 bg-white section-wrapper-2 section-wrapper-6 right">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="menu__photo">
                            <img src="/assets/images/menu/launch/lanch_01.jpg" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="menu__photo">
                            <img src="/assets/images/menu/launch/lanch_02.jpg" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="menu__photo">
                            <img src="/assets/images/menu/launch/lanch_03.jpg" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="menu__photo">
                            <img src="/assets/images/menu/launch/lanch_04.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <img class="bg bg6 dz-move-down" src="/assets/images/menu/back_08.png" alt="/">
</section>
<!-- Image Box-1 -->
