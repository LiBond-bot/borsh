            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="dz-card style-1 blog-half overlay-shine dz-img-effect zoom">
                        <div class="dz-media">
                            <img src="<?=get_template_directory_uri()?>/assets/images/sale/sale_01.png" alt="/">
                        </div>
                        <div class="dz-info">
                            <div class="dz-meta">
                                <ul>
                ...
                <div class="swiper-slide">
                    <div class="dz-card style-1 blog-half overlay-shine dz-img-effect zoom">
                        <div class="dz-media">
                            <img src="<?=get_template_directory_uri()?>/assets/images/sale/sale_02.png" alt="/">
                        </div>
                        <div class="dz-info">
                            <div class="dz-meta">
                                <ul>
                            ...
                            <h5 class="dz-title"><span class="text-primary">Бесплатная </span>доставка *</h5>
                            <p>* Бесплатная доставка от 2х обедов<br>Стоимость доставки одного обеда 100 руб.  </p>
                        </div>
                    </div>
                </div>
            </div>
