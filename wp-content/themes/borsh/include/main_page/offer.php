	...
	<div class="main-slider-2">
		<div class="banner-inner">
					...
					<div class="col-xl-6 col-lg-5 col-md-5">
						<div class="banner-media">
							...
							<div class="item-media wow fadeInRight dz-move-down" data-wow-delay="1s" data-speed-x="-2" data-speed-scale="-1">
								<img src="<?=get_template_directory_uri()?>/assets/images/offer/back_04.png" class="img2" alt="/">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="offer__launch-1">
				<img src="<?=get_template_directory_uri()?>/assets/images/offer/back_01.png" alt="">
			</div>
		</div>
	</div>
</div>