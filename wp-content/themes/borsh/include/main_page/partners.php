<!-- Service Section -->
<section id="partners" class="partners section-wrapper-4 content-inner-1 overflow-hidden bg-parallax" style="background-image:url('<?=get_template_directory_uri()?>/assets/images/background/back_02.png'); background-attachment: fixed; background-size: 800px;">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                <div class="dz-media rounded-md partners__img">
                    <img src="<?=get_template_directory_uri()?>/assets/images/partners/back_01.jpg" alt="/">
                </div>
            </div>
                        ...
                        <div class="col-lg-6 col-md-6 m-b30">
                            <div class="icon-bx-wraper style-2">
                                <div class="icon-bx radius">
                                    <div>
                                        <img src="<?=get_template_directory_uri()?>/assets/images/icons/coffee-machine.png" alt="">
                                    </div>
                                </div>
                                <div class="icon-content">
                                    <h5 class="dz-title">Кофейнями, кулинарными лавками и буфетами</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 m-b30">
                            <div class="icon-bx-wraper style-2">
                                <div class="icon-bx radius">
                                    <div>
                                        <img src="<?=get_template_directory_uri()?>/assets/images/icons/market.png" alt="">
                                    </div>
                                </div>
                                <div class="icon-content">
                                    <h5 class="dz-title">Продуктовыми<br>магазинами и рынками</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 m-b30">
                            <div class="icon-bx-wraper style-2">
                                <div class="icon-bx radius">
                                    <div>
                                        <img src="<?=get_template_directory_uri()?>/assets/images/icons/gym.png" alt="">
                                    </div>
                                </div>
                                <div class="icon-content">
                                    <h5 class="dz-title">Фитнес-<br>и бизнес-центрами</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 m-b30">
                            <div class="icon-bx-wraper style-2">
                                <div class="icon-bx radius">
                                    <div>
                                        <img src="<?=get_template_directory_uri()?>/assets/images/icons/vending-machine.png" alt="">
                                    </div>
                                </div>
                                <div class="icon-content">
                                    <h5 class="dz-title">Собственниками вендинговых аппаратов</h5>
                                </div>
                            </div>
                        </div>
                    </div>
