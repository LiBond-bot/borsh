        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="dz-form-card bg-primary mb-5 mb-lg-0 dz-form-card_footer" id="formMenu">
                    ...
                    <input type="hidden" name="title" value="Узнать меню розница">
                    <input type="hidden" name="WhereForm" value="Форма узнать меню после допов">
                    ...
                    <form class="dzForm dezPlaceAni">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <button type="submit" name="submit" value="submit" class="btn btn-md btn-white btn-hover-1"><span>Запросить</span></button>	
                            </div>
                            <div class="mt-3" style="font-size:14px;">
                                Нажимая кнопку <b>"Запросить"</b>, вы соглашаетесь с <b><a href="/privacy-policy/">Политикой конфиденциальности</a></b>
                            </div>
                        </div>
                    </form>
                </div>
