<div class="modal fade" id="sale" data-bs-keyboard="false" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="dz-form-card bg-primary mb-5 mb-lg-0 dz-form-card_footer" id="formSale">
                    ...
                    <div class="section-head">
                        <h4 class="title m-0">Акция</h4>
                        <p class="m-t10"></p>
                    </div>
                    <input type="hidden" name="title" value="Получить акцию">
                    <input type="hidden" name="WhereForm" value="Форма с акции">
