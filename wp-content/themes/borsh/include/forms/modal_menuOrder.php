<div class="modal fade" id="MenuOrder" data-bs-keyboard="false" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="dz-form-card bg-primary mb-5 mb-lg-0 dz-form-card_footer" id="FormMenuOrder">
                    ...
                    <div class="section-head">
                        <h4 class="title m-0">Привезем вкусный обед<br>для вас в любой день недели!</h4>
                        <p class="m-t10">Доставка от двух обедов БЕСПЛАТНО. Принимаем заказы ежедневно</p>
                    </div>
                    <input type="hidden" name="title" value="Заказ обеда розница">
                    <input type="hidden" name="WhereForm" value="Форма заказать обед после допов">
                    ...
                    <form class="dzForm dezPlaceAni">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="input-group input-line">
                                    <input name="adress" required type="text" class="form-control" placeholder="Ваш адрес">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="input-group input-line">
