<div class="modal fade" id="blockpartners" data-bs-keyboard="false" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="dz-form-card bg-primary mb-5 mb-lg-0 dz-form-card_footer" id="partnersForm">
                    ...
                    <div class="section-head">
                        <h4 class="title m-0">Сертифицированная продукция для вашего бизнеса</h4>
                        <p class="m-t10">Заполните форму заказа и отправьте нам</p>
                    </div>
                    <input type="hidden" name="title" value="Быстрый заказ">
                    <input type="hidden" name="WhereForm" value="Форма БОРЩ — ваш надежный поставщик">
