	...
	<section class="content-inner-1">
		<div class="container">
			...
			<div>
				...
				<p>Чтобы в срок предоставлять вам качественные продукты, которые вы сможете реализовать в своем магазине, на нашем предприятии действуют: </p>
			</div>
				...
				<div class="col-lg-3 col-sm-6 m-b30">
					<div class="icon-bx-wraper style-3">
						...
						<div class="icon-content">
							...
							<p>Доставка вовремя, соблюдая все условия хранения</p>
						</div>
					</div>
				</div>
			</div>
