					...
					<div class="row">
						<div class="col-lg-2 col-md-12 d-flex align-items-center">
							<div class="input-group input-line">
								<input name="dzName" required type="text" class="form-control" placeholder="Название организации">
							</div>
						</div>
						<div class="col-lg-3 col-md-12 d-flex align-items-center">
							<div class="input-group input-line">
								<input name="dzEmail" required type="text" class="form-control" placeholder="Адрес">
							</div>
						</div>
						<div class="col-lg-3 col-md-12 d-flex align-items-center">
							<div class="input-group input-line">
								<input name="dzEmail" required type="text" class="form-control" placeholder="Количество обедов">
							</div>
						</div>
						<div class="col-lg-3 col-md-12 d-flex align-items-center">
							<div class="input-group input-line">
