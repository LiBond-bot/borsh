...
?>
	...
	<section class="content-inner pb-0">
		<div class="container">
			...
			<div class="row">
				<div class="col-12">
					<p>Более шести лет наша команда производит и доставляет комплекс готовых блюд и является поставщиком корпоративного питания в нашем городе. Обширное меню и по-домашнему вкусные авторские угощения от наших поваров и кондитеров. Чтобы вы могли составить сбалансированный и разнообразный рацион!</p>
				</div>
			</div>
		</div>
	</section>
