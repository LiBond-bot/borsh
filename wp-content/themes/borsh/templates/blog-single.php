				...
				<div class="col-xl-12 col-lg-12">
					<div class="blog-single dz-card sidebar">
						<div class="dz-media rounded-md">
							<img src="<?=get_template_directory_uri()?>/assets/images/blog/detail/pic1.jpg" alt="/">
						</div>
						<div class="dz-info">
							...
							<div class="clearfix">
								...
								<ul class="comment-list">
									<li class="comment">
										<div class="comment-body">
											<div class="comment-author vcard"> 
												<img  class="avatar photo" src="<?=get_template_directory_uri()?>/assets/images/testimonial/mini/pic1.jpg" alt="/"> 
										...
										<ol class="children">
											<li class="comment odd parent">
												<div class="comment-body">
													<div class="comment-author vcard"> 
														<img  class="avatar photo" src="<?=get_template_directory_uri()?>/assets/images/testimonial/mini/pic2.jpg" alt="/"> 
									...
									<li class="comment">
										<div class="comment-body">
											<div class="comment-author vcard"> 
												<img  class="avatar photo" src="<?=get_template_directory_uri()?>/assets/images/testimonial/mini/pic3.jpg" alt="/"> 
